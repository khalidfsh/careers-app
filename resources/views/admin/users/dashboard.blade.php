            ...
            <div class="btn-group grow max-w-md justify-center gap-2">
                ...
                <div>
                    <label class="label cursor-pointer">
                        ...
                        <span
                            class="label-text text-base ms-1 text-gray-700 dark:text-gray-300">{{ __('Only active') }}</span>
                    </label>
                </div>
                <div>
                    <label class="label cursor-pointer">
                        <x-checkbox class="checkbox-md" wire:model="" />
                        <span
                            class="label-text text-base ms-1 text-gray-700 dark:text-gray-300">{{ __('Only admin') }}</span>
                    </label>
                </div>
                <div>
                    <label class="label cursor-pointer">
                        <x-checkbox class="checkbox-md" wire:model="" />
                        <span
                            class="label-text text-base ms-1 text-gray-700 dark:text-gray-300">{{ __('Has resume') }}</span>
                    </label>
                </div>
            </div>
        </x-slot>
            ...
            @foreach ($users as $user)
                <x-datatable-tr iteration="{{ $loop->iteration }}">
                    <x-datatable-td :wrap=false>
                        <div class="flex items-center gap-1 me-1">
